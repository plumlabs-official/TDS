 ...
 *
 * Source: cds-docs/code.js (lines 50-119)
 */
...
/** Root frame with white background bound to CDS 'background' variable */
...
/** Create text node with CDS color variable binding. Caller must pre-load Inter fonts. */
